...
def gamestartui():
    ...
    i2.convert()
    i3 = pygame.image.load("D:/i3.png")
    i3.convert()
    i4 = pygame.image.load("D:/i4.png")
    i4.convert()
    ...
    while n1:
        ...
        elif x1 >= 160 and x1 <= 410 and y1 >= 310 and y1 <= 360:
            start_ck.blit(i3, (160, 310))
            if buttons[0]:
                pygame.quit()
                exit()
        elif x1 >= 450 and x1 <= 560 and y1 >= 150 and y1 <= 184:
            start_ck.blit(i4,(450, 150))
        else:
            start_ck.blit(i1, (160, 150))
            start_ck.blit(i2, (160, 230))
            start_ck.blit(i3, (160, 310))
